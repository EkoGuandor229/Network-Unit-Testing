...
\newcommand{\titel}{Sitzung Design 2}
\newcommand{\untertitel}{Studienarbeit \semester}
\newcommand{\kompletterTitel}{\titel{} \\ \untertitel}
\newcommand{\datum}{26.03.2020}
...
\section*{Traktanden}
\begin{enumerate}
	\item Besprechung der Domainanalyse
\end{enumerate}

\section*{Beschlüsse}
	\begin{itemize}
		\item Im Klassendiagram fehlt das Format der Resultate der Tests.
	\end{itemize}
...
\begin{tabularx}{0.9\linewidth}{Xll}
	...
	\midrule
	 Korrekturen Klassendiagram & Mike Schmid, Janik Schlatter & 01.04.2020 \\
	\bottomrule
\end{tabularx}

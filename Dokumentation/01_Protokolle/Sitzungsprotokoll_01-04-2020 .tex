...
\newcommand{\titel}{Sitzung Design 3}
\newcommand{\untertitel}{Studienarbeit \semester}
\newcommand{\kompletterTitel}{\titel{} \\ \untertitel}
\newcommand{\datum}{1.04.2020}
...
\section*{Traktanden}
\begin{enumerate}
	\item Besprechung Architekturdokumentation
	\item Besprechung Prototyp
\end{enumerate}

\section*{Beschlüsse}
	\begin{itemize}
		\item Der Prototyp muss noch beendet werden.
		\item Die Designentscheidungen müssen genauer beschrieben werden.
	\end{itemize}
...
\begin{tabularx}{0.9\linewidth}{Xll}
	...
	\midrule
	 Designentscheidungen erweiternn & Mike Schmid, Janik Schlatter & 08.04.2020 \\
	 Prototyp beenden & Mike Schmid, Janik Schlatter & 08.04.2020 \\
	\bottomrule
\end{tabularx}

...
\newcommand{\titel}{Sitzung Umsetzung 2}
\newcommand{\untertitel}{Studienarbeit \semester}
\newcommand{\kompletterTitel}{\titel{} \\ \untertitel}
\newcommand{\datum}{15.04.2020}
...
\section*{Beschlüsse}
	\begin{itemize}
		\item In dieser Woche wurden keine weiteren Beschlüsse gefällt.
	\end{itemize}
...
\begin{tabularx}{0.9\linewidth}{Xll}
	...
	\midrule
	 Test Controller \& Runner \& Evaluator Implementation & Mike Schmid & 22.04.2020 \\
	 Connection \& Test Builder \& Test Order  & Janik Schlatter & 22.04.2020 \\
	\bottomrule
\end{tabularx}
